...
function mytheme_enqueue_front_page_scripts() {
    if( is_front_page() )
    {
		...
		wp_enqueue_style( 'owlcarouseltheme', get_stylesheet_directory_uri() . '/js/owl-carousel/owl.theme.default.min.css', array() );
...
function genesischild_footer_creds_text () {
 echo '<div class="credits-section"><div class="wrap"><p class="copyright">Copyright © 2015 - All rights reserved</p><p class="site-links"><a href="/site-map/">Site Map</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="/privacy-policy/">Privacy Policy</a></p></div></div>';
}
